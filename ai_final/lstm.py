...
def get_notes():
    ...
    for file in glob.glob("midi_hope/*.mid"):
...
def create_network(network_input, n_vocab):
    ...
    model.add(LSTM(512, return_sequences=True, recurrent_dropout=0,recurrent_activation='sigmoid'))
    model.add(LSTM(512, recurrent_activation='sigmoid'))
    model.add(BatchNorm())
